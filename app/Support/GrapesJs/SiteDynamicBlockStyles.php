...
.ts-ba-gallery__cover{position:relative;display:block;width:100%;padding:0;border:0;background:color-mix(in srgb,var(--color-muted) 28%,transparent);cursor:zoom-in}
.ts-ba-gallery__cover:focus-visible{outline:2px solid var(--color-accent,var(--color-primary));outline-offset:2px}
.ts-ba-gallery__cover img,.ts-ba-gallery__photo{display:block;width:100%;height:auto;aspect-ratio:16/10;object-fit:cover}
...
@media (max-width:520px){
  ...
  .ts-ba-gallery__cover img,.ts-ba-gallery__photo{aspect-ratio:4/3}
}
